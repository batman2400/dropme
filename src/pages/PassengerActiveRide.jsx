  ...
  if (status === 'pending') {
    return (
      <div className="bg-surface text-on-surface font-body min-h-screen pb-24">
        ...
        <main className="px-5 sm:px-6 pt-8 content-grid">
          <div className="flex flex-col items-center justify-center space-y-8 animate-fade-up">
            ...
            <div className="w-full bg-surface-container-lowest rounded-xl p-4 border border-outline-variant/6 mt-4">
  ...
  if (status === 'rejected' || status === 'cancelled') {
    return (
      <div className="bg-surface text-on-surface font-body min-h-screen pb-28">
        ...
        <main className="px-5 sm:px-6 pt-12 content-grid">
  ...
  if (status === 'accepted') {
    return (
      <div className="bg-surface text-on-surface font-body min-h-screen pb-28">
        ...
        <main className="px-5 sm:px-6 pt-5 content-grid">
          ...
          <section className="bg-surface-container-lowest rounded-2xl p-5 border border-outline-variant/6 mb-5 animate-fade-up stagger-2 relative overflow-hidden">
          ...
          <section className="bg-surface-container-lowest rounded-2xl p-5 border border-outline-variant/6 animate-fade-up stagger-3">
          ...
          {driver?.phone_number && (
            <a
              ...
              className="w-full flex items-center justify-center gap-3 bg-[#25D366] text-white py-3.5 rounded-xl font-bold text-sm shadow-md shadow-[#25D366]/15 active:scale-[0.98] transition-transform animate-fade-up stagger-4 mt-4"
            >
